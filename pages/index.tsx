      ...
      <main className='flex flex-col w-full'>
        ...
        <div className='p-4 self-center'>
          <div className='max-w-4xl text-center'>
            ...
            <p className='text-base'> е Адвокатско дружество обединило дейността на двамата управляващи съдружници – адвокат Иван Тодоров Грошев и адвокат Гина Иванова Грошева.
