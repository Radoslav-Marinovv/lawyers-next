    ...
    <>
      ...
      <div className='flex flex-col h-full w-full' >
        ...
        <div className='max-w-4xl self-center text-justify py-4'>
          ...
          <p className='text-lg indent-10 p-2'>
            Екипът на адвокатско дружество „Грошев и парньори” е специализирано в различните области на правото.
          </p>
          <p className='text-lg font-medium indent-10 p-2'>
            Управляващият съдружник - адв. Иван Грошев, е специалист в сферата на наказателното право с повече от 37 години опит, от които 30 като адвокат, а адв. Гина Грошева e специалист в сферата на публичното, гражданско право и процес, по-конкретно във вещно, облигационно и търговско право, банково и застрахователно право.
          </p>
          <p className='text-lg font-medium indent-10 p-2'>
